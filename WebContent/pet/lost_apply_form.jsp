...
<tr>
   ...
   <td><input type = "number" size = "5" name="age" placeholder = "숫자만 입력해주세요." required><a style ="font-size:5px">&nbsp;&nbsp;(추청 나이 입력 가능)</a></td>
</tr>
<tr>
...
<tr>
   ...
   <td><input type = "text" placeholder = "MMDD" name = "pdate" required></td>
</tr>
<tr>
